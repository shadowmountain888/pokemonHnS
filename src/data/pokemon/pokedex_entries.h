const struct PokedexEntry gPokedexEntries[] =
{
    ...
    [NATIONAL_DEX_CELEBI] =
    {
        .categoryName = _("{JPN}じかんりょこうポケモン"),
        .height = 6,
        .weight = 50,
