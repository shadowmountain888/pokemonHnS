...
#define SPECIES_NAME_LENGTH 12 // Display name length for gSpeciesNames (separate from POKEMON_NAME_LENGTH which sizes save data)
...
#define TRAINER_CLASS_NAME_LENGTH 22
